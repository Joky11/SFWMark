        ...
        with torch.no_grad():
            ...
            if args.wm_type == "OSS":
                ...
                for i, idx in enumerate(batch_indices):
                    ...
                    wm_latent = oss_embed(single_latent, msg, oss_seed, alpha_scale=args.alpha_scale)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--alpha_scale", type=float, default=0.5, help="OSS 自适应嵌入强度缩放因子，alpha = alpha_scale * std(X_free)")
